...
const Vec3d local_pseudo_n_0 = Vec3d(0.0, 0.0, 1.0);
const Vec3d local_pseudo_b_n_0 = Vec3d(0.0, 1.0, 0.0);
const Vec3d ZeroVecd = Vec3d::Zero();

inline Vec3d degradeToVecd(const Vec3d &input) { return input; };
